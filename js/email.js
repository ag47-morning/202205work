...
function sendRequest() {
	...
	var rnd = Math.random();
	//var name = escapeThis(document.getElementById("name").value);
	//var email = escapeThis(document.getElementById("email").value);
	//var subject = escapeThis(document.getElementById("subject").value);
	...
	jQuery('#contactWrapper').append('<div class="success"><h4 style="color: #fff;">메일을 발송했습니다.</h4><br><p><strong>'+document.getElementById("name").value+'</strong>님께서 메일을 전송하였습니다.<br>빠른 시일 내에 답변 드리도록 하겠습니다.<br>감사합니다.</p></div>');
	}
}
...
function check_values() {
	...
	var errors=0;
	 ...
	 if($j('#contactform #name').val()=='') {
	 	...
	 	if(!hasClass)
	 	    $j('#contactform #name').parent().append('<label for="contactname" generated="true" class="error">성함을 입력해주세요</label>');
		...
		var hasClass=$j('#contactform #email').parent().find(".error").hasClass("error");
	 	if(!hasClass)
	 	    $j('#contactform #email').parent().append('<label for="contactname" generated="true" class="error">이메일 주소를 입력해주세요</label>');
		...
		var hasClass=$j('#contactform #subject').parent().find(".error").hasClass("error");
	 	if(!hasClass)
	 	    $j('#contactform #subject').parent().append('<label for="contactname" generated="true" class="error">메일제목을 입력해주세요</label>');
		...
		var hasClass=$j('#contactform #body').parent().find(".error").hasClass("error");
	 	if(!hasClass)
	 	    $j('#contactform #body').parent().append('<label for="contactname" generated="true" class="error">내용을 입력해주세요</label>');
...
function check_values_loans() {
	...
	var errors=0;
	 ...
	 if($j('#contactform #name').val()=='') {
	 	var hasClass=$j('#contactform #name').parent().find(".error").hasClass("error");
	 	if(!hasClass)
	 	    $j('#contactform #name').parent().append('<label for="contactname" generated="true" class="error">이메일 주소를 정확하게 입력해 주세요.</label>');
			$j('#contactform #name').focus();
			//return false;
			errors++;
		}
...
function check_values_booking() {
	...
	var errors=0;
	 ...
	 if($j('#contactform_booking #name').val()=='') {
	 	...
	 	if(!hasClass)
	 	    $j('#contactform_booking #name').parent().append('<label for="contactname" generated="true" class="error">이름을 입력해주세요</label>');
		...
		var hasClass=$j('#contactform_booking #email').parent().find(".error").hasClass("error");
	 	if(!hasClass)
	 	    $j('#contactform_booking #email').parent().append('<label for="contactname" generated="true" class="error">이메일 주소를 입력해주세요</label>');
 ...
 if($j('#contactform_booking #rooms').val()=='') {
		...
		var hasClass=$j('#contactform_booking #body').parent().find(".error").hasClass("error");
	 	if(!hasClass)
	 	    $j('#contactform_booking #body').parent().append('<label for="contactname" generated="true" class="error">내용을 입력해주세요</label>');
...
function check_values_popup() {
	...
	var errors=0;
	 ...
	 if($j('#contactform_popup #name_popup').val()=='') {
	 	...
	 	if(!hasClass)
	 	    $j('#contactform_popup #name_popup').parent().append('<label for="contactname" generated="true" class="error">성함을 입력해주세요</label>');
		...
		var hasClass=$j('#contactform_popup #email_popup').parent().find(".error").hasClass("error");
	 	if(!hasClass)
	 	    $j('#contactform_popup #email_popup').parent().append('<label for="contactname" generated="true" class="error">이메일 주소를 입력해주세요</label>');
		...
		var hasClass=$j('#contactform_popup #subject_popup').parent().find(".error").hasClass("error");
	 	if(!hasClass)
	 	    $j('#contactform_popup #subject_popup').parent().append('<label for="contactname" generated="true" class="error">메일제목을 입력해주세요</label>');
		...
		var hasClass=$j('#contactform_popup #body_popup').parent().find(".error").hasClass("error");
	 	if(!hasClass)
	 	    $j('#contactform_popup #body_popup').parent().append('<label for="contactname" generated="true" class="error">내용을 입력해주세요</label>');
...
function check_values_news() {
	...
	var errors=0;
	 ...
	 if($j('#newsletterform #name_news').val()=='') {
	 	...
	 	if(!hasClass)
	 	    $j('#newsletterform #name_news').parent().append('<label for="contactname" generated="true" class="error">성함을 입력해주세요</label>');
		...
		var hasClass=$j('#newsletterform #email_news').parent().find(".error").hasClass("error");
	 	if(!hasClass)
	 	    $j('#newsletterform #email_news').parent().append('<label for="contactname" generated="true" class="error">이메일 주소를 입력해주세요</label>');
